...
import 'package:hlayiso/screen/HomeScreen.dart';
import 'package:hlayiso/utils/download_helper.dart';
          ...
          flexibleSpace: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  getColorFromHex(getStringAsync(GRADIENT1),
                      defaultColor: primaryColor1),
                  getColorFromHex(getStringAsync(GRADIENT2),
                      defaultColor: primaryColor1),
                ],
              ),
            ),
          ...
          children: [
            InAppWebView(
              ...
              onLoadStop: (controller, url) async {
                ...
                if (getStringAsync(DISABLE_HEADER) == "true") {
                  webViewController!.evaluateJavascript(
                      source:
                          'document.getElementsByClassName("Header_scrolling__3khE2")[0].style.display="none";');
              ...
              onDownloadStartRequest: (controller, url) async {
                bool value = await checkPermissionOpen();
                if (value) {
                  ...
                  launchUrl(url.url, mode: LaunchMode.externalApplication);
                }
              },
            ...
            Loaders(name: appStore.loaderValues)
                .center()
